 ...
 * Phoenix-RTOS
 *
 * TEBF0808 evaluation board PCI Express init sequence
 *
...
int si5345_waitForCalibration(void)
{
	...
	while (calibration_busy == 1) {
		...
		calibration_busy = ((((calibration_status) & (0x10)) >> 5) | ((internal_statusReg) & (0x01)));
...
int main(int argc, char **argv)
{
	...
	oid_t oid;
	char *path = "/dev/pcie-clock";
	if (create_dev(&oid, path) < 0) {
		fprintf(stderr, "pcie-clock: cannot create device file\n");
		return EXIT_FAILURE;
	}
