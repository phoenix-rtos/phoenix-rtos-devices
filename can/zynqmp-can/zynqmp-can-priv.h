...
typedef enum {
	zynqmp_can_opSend = 0, /**< Send CAN frames */
	zynqmp_can_opRecv = 1, /**< Receive CAN frames */
...
typedef struct {
	...
	time_t timeoutUs;      /**< Timeout for the operation in microseconds */
	bool blockTxOperation; /**< Switch to enable or disable blocking for send operations */
} zynqmp_canDriverReq;
