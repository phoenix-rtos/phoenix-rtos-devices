...
typedef struct _serial_nor_config_option_t {
	 union {
		  struct {
...
typedef struct _flexspi_mem_config_t
{
	...
	flexspi_lut_seq_t deviceModeSeq;			// Device mode sequence info, [7:0] - LUT sequence id, [15:8] - LUt
	...
	flexspi_lut_seq_t configCmdSeqs[3];			// Sequence info for Device Configuration command, similar as deviceModeSeq
	...
	flexspi_lut_seq_t lutCustomSeq[12];			// Customizable LUT Sequences
