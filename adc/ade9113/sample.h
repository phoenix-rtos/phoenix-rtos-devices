...
#ifndef ADE9113_SAMPLE_H
#define ADE9113_SAMPLE_H
...
ssize_t sample_readPoll(struct sampleReader *reader); /* return number of bytes ready to be read */
...
#endif /* end of include guard: ADE9113_SAMPLE_H */
