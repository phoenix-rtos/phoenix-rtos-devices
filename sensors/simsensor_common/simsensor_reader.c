...
static int reader_getFieldLLong(char **actField, long long *res)
{
	char *endptr;
...
static int reader_accelDataParse(const char *startOfDataSection, time_t timestamp, sensor_event_t *result)
{
	char *actField;
	long long tmp;
...
static int reader_baroDataParse(const char *startOfDataSection, time_t timestamp, sensor_event_t *result)
{
	char *actField;
	long long tmp;
...
static int reader_magDataParse(const char *startOfDataSection, time_t timestamp, sensor_event_t *result)
{
	char *actField;
	long long tmp;
...
static int reader_tempDataParse(const char *startOfDataSection, time_t timestamp, sensor_event_t *result)
{
	char *actField;
	long long tmp;
