...
{
	flashdrv_dma_t *dma = mmap(NULL, _PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_ANONYMOUS | MAP_UNCACHED, -1, 0);
	dma->last = NULL;
	dma->first = NULL;
...
{
	flashdrv_common.dma  = mmap(NULL, 2 * _PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_DEVICE, FD_PHYSMEM, 0x1804000);
	flashdrv_common.gpmi = mmap(NULL, 2 * _PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_DEVICE, FD_PHYSMEM, 0x1806000);
	flashdrv_common.bch  = mmap(NULL, 4 * _PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_DEVICE, FD_PHYSMEM, 0x1808000);
	flashdrv_common.mux  = mmap(NULL, 4 * _PAGE_SIZE, PROT_READ | PROT_WRITE, MAP_DEVICE, FD_PHYSMEM, 0x20e0000);
