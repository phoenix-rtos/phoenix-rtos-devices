...
#define CMP_CC(v, c) (tty->term.c_cc[v] != _POSIX_VDISABLE && tty->term.c_cc[v] == (c))
#define CMP_FLAG(field, opt) ((tty->term.c_##field##flag & (opt)) != 0)
...
static inline bool libttydisc_rx_have_breakchar(libtty_common_t *tty)
{
