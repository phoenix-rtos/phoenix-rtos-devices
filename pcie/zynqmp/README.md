...
# Using the library
For most device drivers, following setup should be sufficient:
...
# Notes
1. This driver has dependency on library from `phoenix-rtos-corelibs` called `loglib`
2. There are many PCIe functionalities that have not been implemented, but using `pci_findCapability` you should be able to do what you need.