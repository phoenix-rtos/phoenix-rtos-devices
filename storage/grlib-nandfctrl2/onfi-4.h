...
#ifndef NANDFCTRL2_ONFI_H_
#define NANDFCTRL2_ONFI_H_

#include <stdint.h>


#define ONFI_TCCS_BASE 500 /* ns, base tCCS before parameter page read */
...
static inline int onfi_calcTimingMode(onfi_paramPage_t *page)
{
	if (page->timingMode == 0) {
		return 0;
	}
