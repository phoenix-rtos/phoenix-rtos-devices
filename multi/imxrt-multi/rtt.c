...
#define RTT_0_POS      0
#define RTT_1_POS      (RTT_0_POS + RTT_0)
#define RTT_ACTIVE_CNT (RTT_0 + RTT_1)
...
static const int rttConfig[] = { RTT_0, RTT_1 };


static const int rttBlocking[] = { RTT_0_BLOCKING, RTT_1_BLOCKING };


static const int rttPos[] = { RTT_0_POS, RTT_1_POS };
