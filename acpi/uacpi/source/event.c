...
static uacpi_interrupt_ret handle_gpes(unsigned int n, uacpi_handle opaque)
{
...
static uacpi_interrupt_ret handle_global_lock(unsigned int n, uacpi_handle ctx)
{
...
static uacpi_interrupt_ret handle_sci(unsigned int n, uacpi_handle ctx)
{
    uacpi_interrupt_ret int_ret = UACPI_INTERRUPT_NOT_HANDLED;

    int_ret |= handle_fixed_events();
	int_ret |= handle_gpes(n, ctx);
