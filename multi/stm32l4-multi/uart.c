...
#define UART_CNT (UART1 + UART2 + UART3 + UART4 + UART5 + UART6 + UART7 + UART8 + UART9 + UART10)


static libuart_ctx uart_common[UART_CNT];


static const int uartEnabled[] = { UART1, UART2, UART3, UART4, UART5, UART6, UART7, UART8, UART9, UART10 };


static const int uartDMA[] = { UART1_DMA, UART2_DMA, UART3_DMA, UART4_DMA, UART5_DMA, UART6_DMA, UART7_DMA, UART8_DMA, UART9_DMA, UART10_DMA };


static const int uartPos[] = { UART1_POS, UART2_POS, UART3_POS, UART4_POS, UART5_POS, UART6_POS, UART7_POS, UART8_POS, UART9_POS, UART10_POS };
...
int uart_init(void)
{
	...
	for (uart = usart1; uart <= MAX_UART; ++uart) {
