...
typedef enum { gpio_opGetPort, gpio_opSetPort, gpio_opGetPin, gpio_opSetPin, gpio_opGetDir, gpio_opSetDir } gpio_op_t;
...
void i2c_msgInit(uint32_t msgport, id_t baseId);


int libmulti_handleI2c(multi_msg_t *multi);


void spi_msgInit(uint32_t msgport, id_t baseId);


int libmulti_handleSpi(multi_msg_t *multi);


void generic_msgInit(uint32_t msgport, id_t baseId);


int libmulti_handleGeneric(multi_msg_t *multi);
