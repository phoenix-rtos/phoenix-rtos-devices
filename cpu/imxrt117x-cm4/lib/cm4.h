...
// clang-format off
static inline void cm4_enterCritical(void)
{
	__asm__ volatile ("cpsid if");
}


static inline void cm4_exitCritical(void)
{
	__asm__ volatile ("cpsie if");
}


static inline void cm4_wfi(void)
{
...
void _exceptionHandler(int n);


void _systickHandler(void);


void _syscallHandler(int n);


void _pendsvHandler(void);
