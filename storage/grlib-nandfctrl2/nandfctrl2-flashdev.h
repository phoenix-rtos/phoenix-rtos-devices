 ...
 * MTD storage device context and initialisation API.
 *
...
#ifndef _NANDFCTRL2_FLASHDEV_H_
#define _NANDFCTRL2_FLASHDEV_H_
...
typedef struct _storage_devCtx_t {
	...
	unsigned int target; /* Die index passed to flashdrv_* functions */
} storage_devCtx_t;
